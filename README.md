...
![داشبورد تحلیل کلی کسب و کار] (Images/dashboard-overview-page.png)
در این صفحه نمای کلی از عملکرد کسب‌وکار، شاخص‌های کلیدی و ارتباط میان متغیرهایی مانند فروش، سود و تخفیف بررسی می‌شود.
...
در این صفحه عملکرد سودآوری کسب‌وکار و ارتباط آن با فروش و تخفیف مورد بررسی قرار گرفته است.

تحلیل‌های انجام‌شده در این بخش امکان بررسی سود در طول زمان و مقایسه عملکرد بخش‌های مختلف را فراهم می‌کنند.
...
در این صفحه عملکرد محصولات و دسته‌بندی‌ها مورد بررسی قرار گرفته است.

همچنین شاخص‌هایی مانند فروش، سود و درصد سود برای بررسی عملکرد محصولات مورد استفاده قرار گرفته‌اند.

---

### 🛒 صفحه تحلیل سفارش‌ها — (Orders)
[داشبورد تحلیل میزان سفارشات و تحلیل روند آن ها] (Images/dashboard-orders-page.png)

در این صفحه وضعیت سفارش‌ها و الگوی سفارش‌های ثبت‌شده مورد بررسی قرار گرفته است.

همچنین تعداد سفارش‌ها و درصد سفارش‌های مرجوع‌شده در این بخش تحلیل شده‌اند.
...
برای نمایش اطلاعات تکمیلی و جزئیات بیشتر، از صفحات تعاملی مرتبط با **مجموع فروش  در شهرها** استفاده شده است.
